...
public class Database extends SQLiteOpenHelper {
        ...
        // Adding new Reminder
        public int addReminder(Remind reminder){
        ...
        public Remind getReminder(String id){
            ...
            Remind reminder = new Remind(Integer.parseInt(cursor.getString(0)), cursor.getString(1),
        ...
        public ArrayList<Remind> getAllReminders(){
            ArrayList<Remind> reminderList = new ArrayList<>();
        ...
        public int updateReminder(Remind reminder){
            SQLiteDatabase db = this.getWritableDatabase();
            ContentValues values = new ContentValues();
            values.put(KEY_TITLE , reminder.getTitle());
            values.put(KEY_DATE , reminder.getDate());
        ...
        public void deleteReminder(Remind reminder){
            SQLiteDatabase db = this.getWritableDatabase();
